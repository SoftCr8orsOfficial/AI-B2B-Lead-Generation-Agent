...
Streamlit Dashboard - No Plotly Required
"""
...
# ============================================================
# CHARTS - Using Streamlit Native (No Plotly)
# ============================================================
...
if not filtered_df.empty:
    ...
    st.info("ℹ️ No data found. Please run modules first.")
...
with st.expander("🔗 LinkedIn Data"):
    if not filtered_df.empty:
        ...
        if linkedin_cols:
            ...
            st.info("LinkedIn columns not found")
...
with st.expander("👤 Decision Makers"):
    if not filtered_df.empty:
        ...
        if dm_cols:
            ...
            st.info("Decision maker columns not found")
